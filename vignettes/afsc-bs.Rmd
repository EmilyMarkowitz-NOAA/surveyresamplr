...
# Need to install the coldpool package for temperature data
...
spp_list <- data.frame(
  ...
  dplyr::mutate(
    file_name = gsub(pattern = " ", replacement = "_", 
...
# grid_yrs <- replicate_df(surveyresamplr::noaa_afsc_GOA_pred_grid_depth, 
...
ebs_only <- setdiff(names(terra::unwrap(coldpool::ebs_bottom_temperature)), 
...
# save(grid_yrs_depth_temperature, 
# file = paste0("grids/grid_yr_temperature/noaa_afsc_bs_pred_grid_depth_temperature.rdata"))
...
for initial model exploration. Check `your_mesh$mesh$n` to view the number of 
vertices.
Warning in stats::nlminb(start = tmb_obj$par, objective = tmb_obj$fn, 
  gradient = tmb_obj$gr,  :
...
reciprocal condition number = 1.29028e-18\n"
attr(,"class")
[1] "try-error"
attr(,"condition")
<simpleError in solve.default(h, g): system is computationally singular: 
reciprocal condition number = 1.29028e-18>

[[2]]
[1] "Error in solve.default(h, g) : \n  system is computationally singular: 
reciprocal condition number = 1.49831e-19\n"
attr(,"class")
[1] "try-error"
attr(,"condition")
<simpleError in solve.default(h, g): system is computationally singular: 
...
[[3]]
[1] "Error in solve.default(h, g) : \n  system is computationally singular: 
reciprocal condition number = 2.0641e-16\n"
attr(,"class")
[1] "try-error"
attr(,"condition")
<simpleError in solve.default(h, g): system is computationally singular: 
...
[[4]]
[1] "Error in solve.default(h, g) : \n  system is computationally singular: 
reciprocal condition number = 2.36681e-18\n"
attr(,"class")
[1] "try-error"
attr(,"condition")
<simpleError in solve.default(h, g): system is computationally singular: 
...
[[5]]
[1] "Error in solve.default(h, g) : \n  system is computationally singular: 
reciprocal condition number = 2.05487e-57\n"
attr(,"class")
[1] "try-error"
attr(,"condition")
<simpleError in solve.default(h, g): system is computationally singular: 
...
[[6]]
[1] "Error in solve.default(h, g) : \n  system is computationally singular: 
reciprocal condition number = 5.39281e-21\n"
attr(,"class")
[1] "try-error"
attr(,"condition")
<simpleError in solve.default(h, g): system is computationally singular: 
...
[[7]]
[1] "Error in solve.default(h, g) : \n  system is computationally singular: 
reciprocal condition number = 1.47882e-44\n"
attr(,"class")
[1] "try-error"
attr(,"condition")
<simpleError in solve.default(h, g): system is computationally singular: 
...
[[8]]
[1] "Error in `$<-`(`*tmp*`, \"est1\", value = c(61.7707818685793, 
55.6698623088797,  : \n  \033[38;5;252mAssigned data `r$proj_eta[, 1]` must be 
compatible with existing data.\n\033[31m✖\033[38;5;252m Existing data has 
7276038 rows.\n\033[31m✖\033[38;5;252m Assigned data has 5076330 rows.
\n\033[36mℹ\033[38;5;252m Only vectors of size 1 are recycled.\033[39m\n\033
[1mCaused by error in `vectbl_recycle_rhs_rows()`:\033[22m\n\033[33m!\033[39m 
Can't recycle input of size 5076330 to size 7276038.\n"
attr(,"class")
[1] "try-error"
attr(,"condition")
...
[[9]]
[1] "Error in solve.default(h, g) : \n  system is computationally singular: 
reciprocal condition number = 2.94123e-18\n"
attr(,"class")
[1] "try-error"
attr(,"condition")
<simpleError in solve.default(h, g): system is computationally singular: 
...
[1] "try-error"
attr(,"condition")
<simpleError in solve.default(h, g): Lapack routine dgesv: system is exactly 
singular: U[3,3] = 0>
