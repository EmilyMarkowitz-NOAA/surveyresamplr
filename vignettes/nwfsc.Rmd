...
spp_list <- data.frame(
  ...
  common_name = c(
    "arrowtooth flounder", "bocaccio", "canary rockfish", 
  ...
  file_name = c(
    "arrowtooth_flounder", "bocaccio", "canary_rockfish", 
  ...
  filter_lat_gt = c(34, NA, NA, 335, NA, 35, NA, NA, 35, NA, NA, NA, NA, NA, 
                    35.5, 33.5),
  filter_lat_lt = c(NA, NA, NA, NA, NA, NA, 35, NA, NA, NA, NA, NA, NA, NA, NA,
                    NA),
  filter_depth = c(NA, 500, 275, 675, NA, 450, 450, NA, 500, 700, 675, 700, NA, 
                   NA, 425, 675),
  model_fn = c(
  ...
  # model_fn = c( # name of funcion for sdm. Will build in specificity for 
  # this later
